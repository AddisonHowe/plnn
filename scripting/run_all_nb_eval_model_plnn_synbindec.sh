...
sh scripting/_run_all_nb_eval_model_script.sh nb_eval_model_plnn_synbindec

# rundir=notebooks
# argfile=scripting/arglist_nb_eval_model_plnn_synbindec.tsv

# logoutfile=scripting/logs/log_nb_eval_model_plnn_synbindec.o
# logstatusfile=scripting/logs/log_nb_eval_model_plnn_synbindec.status
...
# rm $rundir/tmp_script_nb_eval_model_plnn_synbindec.py
# echo "Done!"