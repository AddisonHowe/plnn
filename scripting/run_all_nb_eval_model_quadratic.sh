...
sh scripting/_run_all_nb_eval_model_script.sh nb_eval_model_quadratic

# rundir=notebooks
# argfile=scripting/arglist_nb_eval_model_quadratic.tsv

# logoutfile=scripting/logs/log_nb_eval_model_quadratic.o
# logstatusfile=scripting/logs/log_nb_eval_model_quadratic.status
...
# rm $rundir/tmp_script_nb_eval_model_quadratic.py
# echo "Done!"